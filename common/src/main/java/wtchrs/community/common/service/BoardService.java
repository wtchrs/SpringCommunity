...
import wtchrs.community.common.repository.BoardAdminRepository;
...
public class BoardService {
     ...
     */
    public Page<Article> getArticles(Long boardId) {
        return getArticles(boardId, PageRequest.of(0, 20));
    }
     ...
     */
    public Page<Article> getArticles(Long boardId, Pageable pageable) {
